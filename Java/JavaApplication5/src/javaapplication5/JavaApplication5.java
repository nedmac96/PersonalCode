...
public class JavaApplication5
{
    ...
    public static void main(String[] args)
    {
        ...
        /*for (B = y = u = b = 0, x = 10, z = 15, I =[],l = []; l[B] = ("ustvrtsuqqqqqqqq" + "yyyyyyyy}{|~z|{}@G@TSb~?A6J57IKJT576,+-48HLSUmgukgg OJNMLK  IDHGFE").charCodeAt(B) - 64,B++ < 120;
        I[B - 1] = B % x ? B / x % x < 2 | B % x < 2 ? 7 : B / x & 4 ? 0 : l[u++] : 7);
        X = (c, h, e, S, s) =  >
        {
            c ^= 8;
            for (var T,o,L,E,D,O = 20,G,N = -1e8,n,g,d = S && X(c, 0) > 1e4,C,R,A,K = 78 - h << 9,a = c ? x : -x; ++O < 99;)
            {
                        ...
                        if (!R && (G || A < 3 || g) || (1 + R & z ^ c) > 9 && G | A > 2)
                        {
                            ...
                            for (E = n = G | I[T - a] - 7 ? o & z : 6 ^ c; E; E = !E && !d && !(g = T, D = T < O ? g - 3 : g + 2, I[D] < z | I[D + O - T] | I[T += T - O])
                            {
                                ...
                                if (S > h || 1 < S & S == h && L > 2 | d)
                                {
                                    ...
                                    {
                                        return W(I, B = b, c, y = E);
                                    }
                                    E = 1 - G | A < 7 | D | !S | R | o < z || X(c, 0) > 1e4;
                                    I[O] = o;
                                    I[T] = R;
                                    I[D] = I[g];D ? I[g] = G ? 0 : 9 ^ c : 0
                                }
        ...
        //"ustvrtsuqqqqqqqq" = "rnb??bnrpppppppp"
